# Draft Existing-Repo Project Baseline With `ff-understand`
...
Implement existing-repository understanding as a draft-first action. Flowflow should inspect repository structure, available package scripts, docs, and observable project facts, then create Project Baseline drafts for user review. It must not automatically overwrite baseline files.

## Acceptance criteria

- [ ] `ff-understand` creates drafts for overview, architecture, rules, and commands.
