...
Encode execution strategy guidance in generated command entries and harness adapters. Flowflow should support inline, subagent, and hybrid execution without changing Repo Truth or task state. Inline execution must remain complete; subagents and hybrid execution should improve context efficiency where supported.
